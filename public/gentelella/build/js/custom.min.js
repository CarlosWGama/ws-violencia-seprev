// var valor = retornaQuantidadeId(3);
// console.log(valor)

// function retornaQuantidadeId(idViolacao) {
//     $.getJSON("http://localhost/violencia_zero/public/api/denuncias", function(
//         data
//     ) {
//         SADESGRACAS = 0
//         for (i = 0; i < data.length; i++) {
//             if (data[i].id_violation_types == idViolacao) {
//                 SADESGRACAS +=1
//             }
//         }
//         console.log(SADESGRACAS)
//     });
// }
...
var vendaBebidasAlcoolicas = 0;
var bullying = 0;
var exploracaoSexual = 0;
var trabalhoInfantil = 0;
var automutilacao = 0;

function setHeader(xhr) {
    xhr.setRequestHeader('HYSDTDWQI14784AJSUDWYQJSKDZLOZLZOZLASDHWQ1487AKK', 'AJUSDYWQYJHNCSA4788145698AKSDIIUQWJ14ASDJUW1S');
}

function init_chart_doughnut() {

    $.ajax({
        url: 'http://localhost/violencia_zero/public/api/denuncias',
        type: 'GET',
        dataType: 'json',
        success: function(data) { 
            for (i = 0; i < data.length; i++) {
                if (data[i].id_violation_types == 1) {
                    vendaBebidasAlcoolicas += 1;
                }
                if (data[i].id_violation_types == 2) {
                    bullying += 1;
                }
                if (data[i].id_violation_types == 3) {
                    exploracaoSexual += 1;
                }
                if (data[i].id_violation_types == 4) {
                    trabalhoInfantil += 1;
                }
                if (data[i].id_violation_types == 5) {
                    automutilacao += 1;
                }
            }
        ...
        if (
            ...
            var a = {
                ...
                data: {
                    ...
                    datasets: [
                        {
                            data: [automutilacao, trabalhoInfantil, exploracaoSexual, bullying, vendaBebidasAlcoolicas],
                            backgroundColor: [
                                "#BDC3C7",
                                "#9B59B6",
                                "#E74C3C",
    ...
    if ("undefined" != typeof $.fn.cropper) {
        ...
        $('[data-toggle="tooltip"]').tooltip(),
            ...
            $.isFunction(document.createElement("canvas").getContext) ||
                $('button[data-method="getCroppedCanvas"]').prop(
                    "disabled",
                    !0
                ),
            "undefined" ==
            ...
            $(".docs-buttons").on("click", "[data-method]", function() {
                ...
                if (
                    ...
                    switch (
                        ((f = a.cropper(d.method, d.option, d.secondOption)),
                        d.method)
                    ) {
                        case "scaleX":
                        case "scaleY":
...
function init_daterangepicker_right() {
    if ("undefined" != typeof $.fn.daterangepicker) {
        ...
        $("#reportrange_right span").html(
            ...
            $("#reportrange_right").on("cancel.daterangepicker", function(
                a,
                b
            ) {
                console.log("cancel event fired");
...
function init_validator() {
    "undefined" != typeof validator &&
        ...
        $("form").submit(function(a) {
            ...
            var b = !0;
            return (
                validator.checkAll($(this)) || (b = !1), b && this.submit(), !1
            );
        }));
}
                ...
                series: [
                    {
                        ...
                        data: [
                            ...
                            { value: 32, name: "invisible", itemStyle: l }
                        ]
                    },
                    {
                        name: "2",
                        ...
                        data: [
                            ...
                            { value: 71, name: "invisible", itemStyle: l }
                        ]
                    },
                    {
                        name: "3",
                        ...
                        data: [
                            ...
                            { value: 97, name: "invisible", itemStyle: l }
                        ]
                    }
                ]
            });
