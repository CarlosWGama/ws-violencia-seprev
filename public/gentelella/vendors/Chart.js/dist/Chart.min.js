			...
			function(t, e, i) {
				...
				(n.prototype = {
					...
					lighten: function(t) {
						...
						return (
							(e[2] += e[2] * t), this.setValues("hsl", e), this
						);
					},
					darken: function(t) {
						var e = this.values.hsl;
					...
					saturate: function(t) {
						var e = this.values.hsl;
						return (
							(e[1] += e[1] * t), this.setValues("hsl", e), this
						);
					},
					...
					whiten: function(t) {
						...
						return (
							(e[1] += e[1] * t), this.setValues("hwb", e), this
						);
					},
					blacken: function(t) {
						var e = this.values.hwb;
						return (
							(e[2] += e[2] * t), this.setValues("hwb", e), this
						);
					},
					greyscale: function() {
						var t = this.values.rgb,
					...
					(n.prototype.setValues = function(t, e) {
						...
						var h;
						for (i = 0; i < t.length; i++)
							(h = Math.max(0, Math.min(r[t][i], o[t][i]))),
								(o[t][i] = Math.round(h));
			...
			function(t, e, i) {
				...
				function s(t) {
					var e,
						...
						s = t[2] / 255;
					return (
						(o = Math.min(1 - n, 1 - r, 1 - s)),
						(e = (1 - n - o) / (1 - o) || 0),
						(i = (1 - r - o) / (1 - o) || 0),
						(a = (1 - s - o) / (1 - o) || 0),
						[100 * e, 100 * i, 100 * a, 100 * o]
					);
				}
				function l(t) {
					...
					(e =
						...
						(a =
							a > 0.04045
								? Math.pow((a + 0.055) / 1.055, 2.4)
								: a / 12.92);
					var o = 0.4124 * e + 0.3576 * i + 0.1805 * a,
						n = 0.2126 * e + 0.7152 * i + 0.0722 * a,
						r = 0.0193 * e + 0.1192 * i + 0.9505 * a;
				...
				function F(t) {
					var e,
						...
						s = t[3] / 100;
					return (
						(e = 1 - Math.min(1, o * (1 - s) + s)),
						(i = 1 - Math.min(1, n * (1 - s) + s)),
				...
				function R(t) {
					var e,
						...
						r = t[2] / 100;
					return (
						(e = 3.2406 * o + -1.5372 * n + r * -0.4986),
						(i = o * -0.9689 + 1.8758 * n + 0.0415 * r),
						(a = 0.0557 * o + n * -0.204 + 1.057 * r),
						(e =
							e > 0.0031308
				...
				function L(t) {
					...
					return (
						8 >= n
							? ((i = (100 * n) / 903.3),
							  (o = 7.787 * (i / 100) + 16 / 116))
							: ((i = 100 * Math.pow((n + 16) / 116, 3)),
							  (o = Math.pow(i / 100, 1 / 3))),
						(e =
							0.008856 >= e / 95.047
								? (e =
										(95.047 * (r / 500 + o - 16 / 116)) /
										7.787)
								: 95.047 * Math.pow(r / 500 + o, 3)),
						(a =
							0.008859 >= a / 108.883
								? (a =
										(108.883 * (o - s / 200 - 16 / 116)) /
										7.787)
			...
			function(t, e, i) {
				...
				e.exports = function(t) {
					t.Radar = function(e, i) {
						return (
							(i.options = t.helpers.configMerge(
								{ aspectRatio: 1 },
								i.options
							)),
							(i.type = "radar"),
					...
					(t.defaults.bar = {
						...
						(t.controllers.bar = t.DatasetController.extend({
							...
							initialize: function(e, i) {
								t.DatasetController.prototype.initialize.call(
									this,
									e,
									i
								),
							...
							getBarCount: function() {
								...
								return (
									e.each(
										...
										function(e, i) {
											var a = this.chart.getDatasetMeta(
												i
											);
											a.bar &&
												this.chart.isDatasetVisible(
													i
												) &&
												++t;
										},
							...
							updateElement: function(t, i, a) {
								...
								e.extend(t, {
									...
									_model: {
										...
										y: a
											? s
											: this.calculateBarY(i, this.index),
										label: this.chart.data.labels[i],
										datasetLabel: d.label,
										base: a
											? s
											: this.calculateBarBase(
													this.index,
													i
											  ),
							...
							calculateBarWidth: function(t) {
								var e = this.getScaleForId(
										this.getMeta().xAxisID
									),
									i = this.getRuler(t);
								return e.options.stacked
									? i.categoryWidth
									: i.barWidth;
							},
							...
							calculateBarY: function(t, e) {
								...
								if (a.options.stacked) {
									...
									return 0 > o
										? a.getPixelForValue(r + o)
										: a.getPixelForValue(n + o);
								}
								return a.getPixelForValue(o);
							},
							draw: function(t) {
							...
							setHoverStyle: function(t) {
								var i = this.chart.data.datasets[
										t._datasetIndex
									],
									a = t._index,
									o = t.custom || {},
									n = t._model;
								(n.backgroundColor = o.hoverBackgroundColor
									? o.hoverBackgroundColor
									: e.getValueAtIndexOrDefault(
											i.hoverBackgroundColor,
											a,
											e.getHoverColor(n.backgroundColor)
									  )),
									(n.borderColor = o.hoverBorderColor
										? o.hoverBorderColor
										: e.getValueAtIndexOrDefault(
												i.hoverBorderColor,
												a,
												e.getHoverColor(n.borderColor)
										  )),
									(n.borderWidth = o.hoverBorderWidth
										? o.hoverBorderWidth
										: e.getValueAtIndexOrDefault(
												i.hoverBorderWidth,
												a,
						...
						(t.controllers.horizontalBar = t.controllers.bar.extend(
							{
								...
								calculateBarBase: function(t, e) {
									var i = this.getMeta(),
										...
										o = 0;
									if (a.options.stacked) {
										var n = this.chart.data.datasets[t]
											.data[e];
										if (0 > n)
											for (var r = 0; t > r; r++) {
												var s = this.chart.data
														.datasets[r],
													l = this.chart.getDatasetMeta(
														r
													);
												l.bar &&
													l.xAxisID === a.id &&
					...
					(t.defaults.bubble = {
						...
						(t.controllers.bubble = t.DatasetController.extend({
							...
							removeHoverStyle: function(t) {
								...
								(n.radius = o.radius
									? o.radius
									: this.getRadius(i.data[t._index])),
									(n.backgroundColor = o.backgroundColor
										? o.backgroundColor
										: e.getValueAtIndexOrDefault(
												i.backgroundColor,
					...
					(i.doughnut = {
						...
						legendCallback: function(t) {
							...
							var i = t.data,
								...
								o = i.labels;
							if (a.length)
								for (var n = 0; n < a[0].data.length; ++n)
									e.push(
										'<li><span style="background-color:' +
											a[0].backgroundColor[n] +
											'"></span>'
									),
										o[n] && e.push(o[n]),
										e.push("</li>");
						...
						legend: {
							...
							onClick: function(t, e) {
								var i,
									...
									r = this.chart;
								for (
									i = 0, a = (r.data.datasets || []).length;
									a > i;
									++i
								)
									(o = r.getDatasetMeta(i)),
										(o.data[n].hidden = !o.data[n].hidden);
								r.update();
							}
						},
						cutoutPercentage: 50,
						...
						(t.controllers.doughnut = t.controllers.pie = t.DatasetController.extend(
							{
								...
								update: function(t) {
									...
									(a.outerRadius = Math.max(h / 2, 0)),
										(a.innerRadius = Math.max(
											u ? (a.outerRadius / 100) * u : 1,
											0
										)),
										(a.radiusLength =
											(a.outerRadius - a.innerRadius) /
											a.getVisibleDatasetCount()),
										...
										(i.outerRadius =
											a.outerRadius -
											a.radiusLength *
												i.getRingIndex(i.index)),
										(i.innerRadius =
											i.outerRadius - a.radiusLength),
										e.each(c.data, function(e, a) {
								...
								updateElement: function(t, i, a) {
									...
									(y.backgroundColor = v.backgroundColor
										...
										(y.hoverBackgroundColor = v.hoverBackgroundColor
											? v.hoverBackgroundColor
											: x(
													g.hoverBackgroundColor,
													i,
													h.hoverBackgroundColor
											  )),
										...
										(a && l.animateRotate) ||
											(0 === i
												? (y.startAngle = s.rotation)
												: (y.startAngle = o.getMeta().data[
														i - 1
												  ]._model.endAngle),
											(y.endAngle =
												y.startAngle +
					...
					(t.defaults.line = {
						...
						(t.controllers.line = t.DatasetController.extend({
							...
							addElementAndReset: function(e) {
								var i = this,
									a = i.chart.options;
								t.DatasetController.prototype.addElementAndReset.call(
									i,
									e
								),
									a.showLines &&
										0 !== a.elements.line.tension &&
							...
							getPointBackgroundColor: function(t, i) {
								var a = this.chart.options.elements.point
										.backgroundColor,
									o = this.getDataset(),
									n = t.custom || {};
								return (
							...
							updateElement: function(t, i, a) {
								...
								void 0 !== h.radius &&
									void 0 === h.pointRadius &&
									(h.pointRadius = h.radius),
									void 0 !== h.hitRadius &&
										void 0 === h.pointHitRadius &&
										(h.pointHitRadius = h.hitRadius),
									(o = f.getPixelForValue(
										c,
										i,
										d,
										r.chart.isCombo
									...
									(t._model = {
										...
										backgroundColor: r.getPointBackgroundColor(
											t,
											i
										),
										borderColor: r.getPointBorderColor(
											t,
											i
										),
										borderWidth: r.getPointBorderWidth(
											t,
											i
										),
							...
							calculatePointY: function(t, e, i, a) {
								...
								if (d.options.stacked) {
									for (o = 0; i > o; o++)
										(n = l.data.datasets[o]),
											(r = l.getDatasetMeta(o)),
											"line" === r.type &&
												l.isDatasetVisible(o) &&
												(n.data[e] < 0
													? (u += n.data[e] || 0)
													: (c += n.data[e] || 0));
									return 0 > t
										? d.getPixelForValue(u + t)
										: d.getPixelForValue(c + t);
								}
							...
							updateBezierControlPoints: function() {
								...
								for (t = 0, i = l.length; i > t; ++t)
									(a = l[t]),
										(o = a._model),
										(n = e.splineCurve(
											e.previousItem(l, t)._model,
											o,
											e.nextItem(l, t)._model,
											r.dataset._model.tension
										)),
										(o.controlPointPreviousX = Math.max(
											Math.min(n.previous.x, s.right),
											s.left
										)),
										(o.controlPointPreviousY = Math.max(
											Math.min(n.previous.y, s.bottom),
											s.top
										)),
										(o.controlPointNextX = Math.max(
											Math.min(n.next.x, s.right),
											s.left
										)),
										(o.controlPointNextY = Math.max(
											Math.min(n.next.y, s.bottom),
											s.top
										)),
										a.pivot();
							},
							...
							removeHoverStyle: function(t) {
								...
								void 0 !== a.radius &&
									...
									(r.backgroundColor = i.getPointBackgroundColor(
										t,
										o
									)),
									(r.borderColor = i.getPointBorderColor(
										t,
										o
									)),
									(r.borderWidth = i.getPointBorderWidth(
										t,
										o
									));
							}
						...
						(t.controllers.polarArea = t.DatasetController.extend({
							...
							update: function(t) {
								...
								(a.outerRadius = Math.max(
									...
									(i.outerRadius =
										a.outerRadius -
										a.radiusLength * i.index),
									(i.innerRadius =
										i.outerRadius - a.radiusLength),
									(n.count = i.countVisibleElements()),
									e.each(n.data, function(e, a) {
										i.updateElement(e, a, t);
									});
							},
							updateElement: function(t, i, a) {
								for (
									var o = this,
										...
										g = n.data.labels,
										p = o.calculateCircumference(s.data[i]),
										m = (r.left + r.right) / 2,
										b = (r.top + r.bottom) / 2,
										v = 0,
										x = o.getMeta(),
								...
								var k = t.hidden
									...
									w = {
										...
										y: b,
										innerRadius: 0,
										outerRadius: h.animateScale
											? 0
											: u.getDistanceFromCenterForValue(
													s.data[i]
											  ),
										startAngle: h.animateRotate
											? Math.PI * -0.5
											: S,
										endAngle: h.animateRotate
											? Math.PI * -0.5
											: C,
						...
						(t.controllers.radar = t.DatasetController.extend({
							...
							updateBezierControlPoints: function() {
								...
								e.each(
									...
									function(a, o) {
										var n = a._model,
											r = e.splineCurve(
												e.previousItem(i.data, o, !0)
													._model,
												n,
												e.nextItem(i.data, o, !0)
													._model,
												n.tension
											);
										(n.controlPointPreviousX = Math.max(
											Math.min(r.previous.x, t.right),
											t.left
										)),
											(n.controlPointPreviousY = Math.max(
												Math.min(
													r.previous.y,
													t.bottom
												),
											...
											(n.controlPointNextX = Math.max(
												Math.min(r.next.x, t.right),
												t.left
											)),
											(n.controlPointNextY = Math.max(
							...
							setHoverStyle: function(t) {
								...
								(n.radius = a.hoverRadius
									...
									(n.backgroundColor = a.hoverBackgroundColor
									...
									(n.borderColor = a.hoverBorderColor
										? a.hoverBorderColor
										: e.getValueAtIndexOrDefault(
												i.pointHoverBorderColor,
												o,
									...
									(n.borderWidth = a.hoverBorderWidth
										? a.hoverBorderWidth
										: e.getValueAtIndexOrDefault(
												i.pointHoverBorderWidth,
												o,
							...
							removeHoverStyle: function(t) {
								...
								(n.radius = a.radius
									...
									(n.backgroundColor = a.backgroundColor
										? a.backgroundColor
										: e.getValueAtIndexOrDefault(
						...
						(t.animationService = {
							...
							addAnimation: function(t, e, i, a) {
								...
								for (var o = 0; o < this.animations.length; ++o)
									if (this.animations[o].chartInstance === t)
										return void (this.animations[
											o
										].animationObject = e);
							...
							cancelAnimation: function(t) {
								var i = e.findIndex(this.animations, function(
									e
								) {
							...
							requestAnimationFrame: function() {
								var t = this;
								null === t.request &&
									(t.request = e.requestAnimFrame.call(
										window,
										function() {
							...
							startDigest: function() {
								...
								for (var i = 0; i < this.animations.length; )
									null ===
										...
										(this.animations[
											i
										].animationObject.currentStep += 1 + e),
										this.animations[i].animationObject
											.currentStep >
											this.animations[i].animationObject
												.numSteps &&
						...
						e.extend(t.Controller.prototype, {
							initialize: function() {
								return (
									...
									this.initToolTip(),
									this.update(),
									t.pluginService.notifyPlugins("afterInit", [
										this
									]),
									this
								);
							...
							stop: function() {
								return (
									t.animationService.cancelAnimation(this),
									this
								);
							},
							resize: function(t) {
								...
								if (
									(e.each(
										...
										function(e, o) {
											...
											n.type ||
												(n.type =
													e.type || this.config.type),
												i.push(n.type),
												n.controller
													? n.controller.updateIndex(
															o
													  )
													: ((n.controller = new t.controllers[
															n.type
													  ](this, o)),
													  a.push(n.controller));
										},
							...
							update: function(i, a) {
								t.pluginService.notifyPlugins("beforeUpdate", [
									this
								]),
							...
							render: function(i, a) {
								t.pluginService.notifyPlugins("beforeRender", [
									this
								]);
								...
								if (
									...
									(n.numSteps = (i || o.duration) / 16.66),
										(n.easing = o.easing),
										(n.render = function(t, i) {
										...
										(n.onAnimationComplete = o.onComplete),
							...
							draw: function(i) {
								...
								o.save(),
									...
									o.rect(
										this.chartArea.left,
										this.chartArea.top,
										this.chartArea.right -
											this.chartArea.left,
										this.chartArea.bottom -
											this.chartArea.top
									),
									o.clip(),
									e.each(
									...
									o.restore(),
									this.tooltip.transition(a).draw(),
									t.pluginService.notifyPlugins("afterDraw", [
										this,
										a
									]);
							},
							...
							destroy: function() {
								...
								(i.width = this.chart.width),
									...
									void 0 !==
										this.chart.originalDevicePixelRatio &&
									...
									t.pluginService.notifyPlugins("destroy", [
										this
									]),
								...
								return (
									...
									"mouseout" === t.type
										...
										: ((i.active = i.getElementsAtEventForMode(
										  ...
										  (i.tooltipActive = i.getElementsAtEventForMode(
												t,
												r.mode
										  ))),
									n.onHover && n.onHover.call(i, i.active),
									("mouseup" === t.type ||
										"click" === t.type) &&
										(o.onClick &&
											o.onClick.call(i, t, i.active),
										i.legend &&
											i.legend.handleEvent &&
											i.legend.handleEvent(t)),
									i.lastActive.length &&
										i.updateHoverStyle(
											i.lastActive,
											n.mode,
									...
									i.animating ||
										...
										(i.stop(),
										(r.enabled || r.custom) && a.update(!0),
										i.render(n.animationDuration, !0)),
									(i.lastActive = i.active),
									(i.lastTooltipActive = i.tooltipActive),
									i
								);
							}
						});
					...
					(t.DatasetController = function(t, e) {
						...
						e.extend(t.DatasetController.prototype, {
							...
							addElementAndReset: function(t) {
								...
								e.getMeta().data.splice(t, 0, i),
									e.updateElement(i, t, !0);
							},
							...
							removeHoverStyle: function(t, i) {
								var a = this.chart.data.datasets[
										t._datasetIndex
									],
									o = t._index,
									n = t.custom || {},
									...
									s = (e.color, t._model);
								(s.backgroundColor = n.backgroundColor
									? n.backgroundColor
									: r(
											a.backgroundColor,
											o,
									...
									(s.borderColor = n.borderColor
										? n.borderColor
										: r(a.borderColor, o, i.borderColor)),
									(s.borderWidth = n.borderWidth
										? n.borderWidth
										: r(a.borderWidth, o, i.borderWidth));
							},
							setHoverStyle: function(t) {
								var i = this.chart.data.datasets[
										t._datasetIndex
					...
					(t.elements = {}),
						...
						e.extend(t.Element.prototype, {
							...
							pivot: function() {
								return (
									this._view ||
										(this._view = e.clone(this._model)),
							...
							hasValue: function() {
								return (
									e.isNumber(this._model.x) &&
									e.isNumber(this._model.y)
								);
							}
						}),
			...
			function(t, e, i) {
				...
				e.exports = function(t) {
					...
					function o(t, a, o) {
						...
						return h || d
							? Math.min(h ? e(s, t, o) : c, d ? e(l, r, o) : c)
							: "none";
					}
					var n = (t.helpers = {});
					(n.each = function(t, e, i, a) {
						...
						if (n.isArray(t))
							...
							else for (o = 0; r > o; o++) e.call(i, t[o], o);
						else if ("object" == typeof t) {
							var s = Object.keys(t);
										...
										? a.hasOwnProperty(i)
											? n.each(e, function(e, o) {
													var r = n.getValueOrDefault(
														...
														s = t.scaleService.getScaleDefaults(
															r
														);
													o >= a[i].length ||
													!a[i][o].type
						...
						(n.where = function(t, e) {
							if (n.isArray(t) && Array.prototype.filter)
								return t.filter(e);
							var i = [];
							return (
								n.each(t, function(t) {
					...
					(n.requestAnimFrame = (function() {
						...
						(n.getRelativePosition = function(t, e) {
							...
							return (
								(i = Math.round(
									(((i - s.left - h) / f) * r.width) /
										e.currentDevicePixelRatio
								)),
								(a = Math.round(
									(((a - s.top - d) / g) * r.height) /
										e.currentDevicePixelRatio
								)),
								{ x: i, y: a }
							);
						...
						(n.getMaximumWidth = function(t) {
							var e = t.parentNode,
								i =
									parseInt(n.getStyle(e, "padding-left")) +
									parseInt(n.getStyle(e, "padding-right")),
								a = e.clientWidth - i,
						...
						(n.getMaximumHeight = function(t) {
							var e = t.parentNode,
								i =
									parseInt(n.getStyle(e, "padding-top")) +
									parseInt(n.getStyle(e, "padding-bottom")),
								a = e.clientHeight - i,
						...
						(n.drawRoundedRectangle = function(t, e, i, a, o, n) {
							t.beginPath(),
								t.moveTo(e + n, i),
								t.lineTo(e + a - n, i),
								t.quadraticCurveTo(e + a, i, e + a, i + n),
								t.lineTo(e + a, i + o - n),
								t.quadraticCurveTo(
									e + a,
									i + o,
								...
								t.lineTo(e + n, i + o),
								t.quadraticCurveTo(e, i + o, e, i + o - n),
								t.lineTo(e, i + n),
								t.quadraticCurveTo(e, i, e + n, i),
								t.closePath();
						}),
						(n.color = function(e) {
							return a
						...
						(n.pushAllIfDefined = function(t, e) {
							"undefined" != typeof t &&
								(n.isArray(t) ? e.push.apply(e, t) : e.push(t));
						}),
					...
					var t = function(e, i) {
						(this.config = i),
							...
							(this.width =
								e.canvas.width ||
								parseInt(
									t.helpers.getStyle(e.canvas, "width")
								) ||
								t.helpers.getMaximumWidth(e.canvas)),
							(this.height =
								e.canvas.height ||
								parseInt(
									t.helpers.getStyle(e.canvas, "height")
								) ||
								t.helpers.getMaximumHeight(e.canvas)),
							(this.aspectRatio = this.width / this.height),
							(isNaN(this.aspectRatio) ||
								isFinite(this.aspectRatio) === !1) &&
								(this.aspectRatio =
									void 0 !== i.aspectRatio
										? i.aspectRatio
										: 2),
							(this.originalCanvasStyleWidth =
								e.canvas.style.width),
							(this.originalCanvasStyleHeight =
								e.canvas.style.height),
							t.helpers.retinaScale(this),
							i && (this.controller = new t.Controller(this));
						var a = this;
						return (
							t.helpers.addResizeListener(
								e.canvas.parentNode,
								function() {
									a.controller &&
										a.controller.config.options
											.responsive &&
										a.controller.resize();
								}
							),
					...
					t.layoutService = {
						...
						update: function(t, i, a) {
							function o(t) {
								...
								i
									? ((e = t.update(
											t.options.fullWidth ? p : k,
											y
									  )),
									  (S -= e.height))
									: ((e = t.update(x, v)), (k -= e.width)),
									C.push({
										horizontal: i,
										minSize: e,
										box: t
							...
							function s(t) {
								t.isHorizontal()
									? ((t.left = t.options.fullWidth ? l : w),
									  (t.right = t.options.fullWidth
											? i - l
											: w + k),
									  (t.top = P),
									  (t.bottom = P + t.height),
										...
										e.each(
											...
											function(t, e) {
												var i =
													a.boxWidth +
													l / 2 +
													n.measureText(t.text).width;
												p[p.length - 1] +
													i +
													a.padding >=
													this.width &&
													((m += l + a.padding),
													(p[p.length] = this.left)),
													(u[e] = {
														left: 0,
														top: 0,
														width: i,
					...
					(t.defaults.scale = {
						...
						(t.Scale = t.Element.extend({
							beforeUpdate: function() {
								e.callCallback(this.options.beforeUpdate, [
									this
								]);
							},
							update: function(t, i, a) {
							...
							afterUpdate: function() {
								e.callCallback(this.options.afterUpdate, [
									this
								]);
							},
							...
							beforeDataLimits: function() {
								e.callCallback(this.options.beforeDataLimits, [
									this
								]);
							},
							determineDataLimits: e.noop,
							afterDataLimits: function() {
								e.callCallback(this.options.afterDataLimits, [
									this
								]);
							},
							beforeBuildTicks: function() {
								e.callCallback(this.options.beforeBuildTicks, [
									this
								]);
							},
							buildTicks: e.noop,
							afterBuildTicks: function() {
								e.callCallback(this.options.afterBuildTicks, [
									this
								]);
							},
							...
							convertTicksToLabels: function() {
								this.ticks = this.ticks.map(function(t, e, i) {
									return this.options.ticks.userCallback
										? this.options.ticks.userCallback(
												t,
												e,
												i
										  )
							...
							calculateTickRotation: function() {
								...
								if (
									((this.labelRotation = o.minRotation || 0),
									(this.paddingRight = 0),
									(this.paddingLeft = 0),
									this.options.display && this.isHorizontal())
								) {
									(this.paddingRight = c / 2 + 3),
										(this.paddingLeft = d / 2 + 3),
									...
									for (
										var u,
											...
											p = g,
											m =
												this.getPixelForTick(1) -
												this.getPixelForTick(0) -
												6;
										p > m &&
										this.labelRotation < o.maxRotation;
										...
										if (
											...
											(h = u * d),
											h + n / 2 > this.yLabelWidth &&
												(this.paddingLeft = h + n / 2),
											(this.paddingRight = n / 2),
											f * g > this.maxHeight)
										) {
											this.labelRotation--;
											break;
							...
							fit: function() {
								var i = (this.minSize = {
									...
									m =
										(e.fontString(f, g, p),
										a.gridLines.tickMarkLength);
								if (
									(l
										? (i.width = this.isFullWidth()
												? this.maxWidth -
												  this.margins.left -
												  this.margins.right
												: this.maxWidth)
									...
									if (l) {
										...
										(i.height = Math.min(
											...
											(this.ctx.font = u);
										var x = this.ctx.measureText(
												this.ticks[0]
											).width,
											y = this.ctx.measureText(
												this.ticks[
													this.ticks.length - 1
												]
											).width,
										...
										w
											...
											C > b
												? (i.width += b)
												: (i.width = this.maxWidth),
											(this.paddingTop = h / 2),
											(this.paddingBottom = h / 2);
									}
								}
								this.margins &&
									((this.paddingLeft = Math.max(
							...
							getPixelForTick: function(t, e) {
								...
								return (
									this.top + t * (r / (this.ticks.length - 1))
								);
							},
							...
							draw: function(i) {
								...
								if (a.display) {
									...
									if (
										((h.fillStyle = m), this.isHorizontal())
									) {
										o = !0;
										var _ =
												"bottom" === a.position
										...
										if (
											...
											l && this.ticks.length > l)
										)
											for (
												;
												!n ||
												this.ticks.length / (n || 1) >
													l;
											...
											e.each(
												...
												function(t, r) {
													...
													if (
														...
														var d = this.getPixelForTick(
																r
															),
															f = this.getPixelForTick(
																r,
																u.offsetGridLines
															);
														u.display &&
										...
										if (
											...
											h.save(),
												...
												(h.font = D),
												(h.textBaseline = "middle"),
												h.fillText(f.labelString, 0, 0),
												h.restore();
										}
									}
									if (u.drawBorder) {
										(h.lineWidth = u.lineWidth),
											(h.strokeStyle = u.color);
										var O = this.left,
											W = this.right,
											L = this.top,
											B = this.bottom,
				...
				e.exports = function(t) {
					...
					t.Title = t.Element.extend({
						...
						fit: function() {
							...
							i.isHorizontal()
								? ((l.width = i.maxWidth),
								  (l.height = r ? s + 2 * o.padding : 0))
								: ((l.width = r ? s + 2 * o.padding : 0),
		...
		33: [
			function(t, e, i) {
				...
				e.exports = function(t) {
					function e(t, e) {
						return (
							e && (i.isArray(e) ? (t = t.concat(e)) : t.push(e)),
							t
						);
					}
					var i = t.helpers;
					(t.defaults.global.tooltips = {
						...
						(t.Tooltip = t.Element.extend({
							...
							update: function(t) {
								if (this._active.length) {
									...
									if (
										...
										i.each(
											...
											function(t, e) {
												if (
													this._chartInstance.isDatasetVisible(
														e
													)
												) {
													var i = this._chartInstance.getDatasetMeta(
															e
														),
														o = i.data[a._index];
													if (o) {
									...
									i.extend(this._model, {
										...
										i.extend(this._model, {
											x: Math.round(e.x),
											y: Math.round(e.y),
											caretPadding: i.getValueOrDefault(
												e.padding,
												2
											),
											labelColors: o
									...
									this.determineAlignment(s),
										i.extend(
											this._model,
											this.getBackgroundPoint(
												this._model,
												s
											)
										);
								...
								return (
									t &&
										...
										this._options.tooltips.custom.call(
											this,
											this._model
										),
									this
							...
							getTooltipSize: function(t) {
								...
								return (
									(a.height +=
										t.title.length * t.titleFontSize),
									(a.height +=
										(t.title.length - 1) * t.titleSpacing),
									(a.height += t.title.length
										? t.titleMarginBottom
										: 0),
									(a.height += o * t.bodyFontSize),
									(a.height += o
										? (o - 1) * t.bodySpacing
										: 0),
									(a.height += t.footer.length
										...
										: 0),
									(a.height +=
										t.footer.length * t.footerFontSize),
									(a.height += t.footer.length
										? (t.footer.length - 1) *
										  t.footerSpacing
										: 0),
									...
									i.each(
										t.beforeBody.concat(t.afterBody),
										function(t) {
											a.width = Math.max(
												a.width,
												e.measureText(t).width
								...
								if (0 !== e.opacity) {
									...
									if (this._options.tooltips.enabled) {
										...
										(t.fillStyle = s
											...
											t.fill(),
											this.drawCaret(n, o, r, a),
											(n.x += e.xPadding),
											(n.y += e.yPadding),
											this.drawTitle(n, e, t, r),
											this.drawBody(n, e, t, r),
											this.drawFooter(n, e, t, r);
									}
								}
							}
						}));
							...
							draw: function() {
								function t(t) {
									r._view.skip || s._view.skip
										...
										: n.bezierCurveTo(
												s._view.controlPointNextX,
												s._view.controlPointNextY,
												r._view.controlPointPreviousX,
												r._view.controlPointPreviousY,
												r._view.x,
												r._view.y
										  );
								}
								...
								(n.lineCap =
									o.borderCapStyle || l.borderCapStyle),
									n.setLineDash &&
										n.setLineDash(
											o.borderDash || l.borderDash
										),
									(n.lineDashOffset =
										o.borderDashOffset ||
										l.borderDashOffset),
									(n.lineJoin =
										o.borderJoinStyle || l.borderJoinStyle),
									(n.lineWidth =
										o.borderWidth || l.borderWidth),
									(n.strokeStyle =
										o.borderColor || i.defaultColor),
									n.beginPath(),
									e.each(
										this._children,
										function(t, i) {
								...
								if (!h.skip) {
									...
									if (!(isNaN(u) || 0 >= u)) {
										switch (
											((d.strokeStyle =
												h.borderColor || a),
											(d.lineWidth = e.getValueOrDefault(
												h.borderWidth,
							...
							determineDataLimits: function() {
								...
								void 0 !== this.options.ticks.min &&
									...
									void 0 !== this.options.ticks.max &&
										...
										(this.maxIndex =
											-1 !== t ? t : this.maxIndex)),
									(this.min = this.chart.data.labels[
										this.minIndex
									]),
									(this.max = this.chart.data.labels[
										this.maxIndex
									]);
							},
						...
						a = t.Scale.extend({
							determineDataLimits: function() {
								...
								var i = this,
									...
									l = i.isHorizontal();
								if (
									((i.min = null), (i.max = null), a.stacked)
								) {
									var h = {},
										d = !1,
										c = !1;
								...
								void 0 !== o.min
									...
									: void 0 !== o.suggestedMin &&
									  (i.min = Math.min(i.min, o.suggestedMin)),
									void 0 !== o.max
										? (i.max = o.max)
							...
							buildTicks: function() {
								...
								if (c) d = r(n.fixedStepSize, n.stepSize);
								else {
								...
								var f = Math.floor(a.min / d) * d,
									...
									p = (g - f) / d;
								(p = e.almostEquals(p, Math.round(p), d / 1e3)
									? Math.round(p)
									: Math.ceil(p)),
									l.push(void 0 !== n.min ? n.min : f);
							...
							getPixelForValue: function(t, e, i, a) {
								...
								return r.isHorizontal()
									? ((n = r.width - (s + r.paddingRight)),
									  (o = r.left + (n / c) * (d - h)),
									  Math.round(o + s))
									: ((n = r.height - (r.paddingTop + l)),
									  (o = r.bottom - l - (n / c) * (d - h)),
									  Math.round(o));
							},
							getValueForPixel: function(t) {
								var e = this,
						...
						i = {
							...
							ticks: {
								callback: function(t, i, a) {
									var o =
										t /
										Math.pow(10, Math.floor(e.log10(t)));
									return 1 === o ||
										2 === o ||
										5 === o ||
										0 === i ||
								...
								(i.min = l(o.min, i.min)),
									...
									i.min === i.max &&
										(0 !== i.min && null !== i.min
											? ((i.min = Math.pow(
													10,
													Math.floor(e.log10(i.min)) -
														1
											  )),
											  (i.max = Math.pow(
													10,
													Math.floor(e.log10(i.max)) +
														1
											  )))
											: ((i.min = 1), (i.max = 10)));
							},
					...
					var e = t.helpers,
						...
						o = t.Scale.extend({
							...
							setDimensions: function() {
								...
								this.drawingArea = t.display
									? a / 2 - (o / 2 + t.ticks.backdropPaddingY)
									: a / 2;
							},
							determineDataLimits: function() {
								if (
							...
							buildTicks: function() {
								...
								this.ticks.push(
									...
									this.options.ticks.reverse
										...
										: ((this.start = this.min),
										  (this.end = this.max)),
									(this.zeroLineIndex = this.ticks.indexOf(
										0
									));
							},
							convertTicksToLabels: function() {
							...
							fit: function() {
								...
								for (
									this.ctx.font = v, a = 0;
									a < this.getValueCount();
									a++
								)
									(t = this.getPointPosition(a, x)),
										(o =
								...
								(d = k),
									...
									(s = this.getIndexAngle(r)),
									(h = this.getIndexAngle(l)),
									(u = c / Math.sin(s + Math.PI / 2)),
									(f = d / Math.sin(h + Math.PI / 2)),
									(u = e.isNumber(u) ? u : 0),
									(f = e.isNumber(f) ? f : 0),
									(this.drawingArea = Math.round(
										x - (f + u) / 2
									)),
									this.setCenterPoint(f, u);
							},
							...
							getDistanceFromCenterForValue: function(t) {
								if (null === t) return 0;
								var e =
									this.drawingArea / (this.max - this.min);
							...
							draw: function() {
								if (this.options.display) {
									...
									if (
										(e.each(
											...
											function(a, o) {
												if (
													...
													var n = this.getDistanceFromCenterForValue(
															this.ticks[o]
														),
														r = this.yCenter - n;
													if (
														...
														if (
															((t.strokeStyle = this.options.gridLines.color),
															(t.lineWidth = this.options.gridLines.lineWidth),
															this.options
																.lineArc)
														)
															t.beginPath(),
										...
										(t.lineWidth = this.options.angleLines.lineWidth),
											(t.strokeStyle = this.options.angleLines.color);
										for (
											var a = this.getValueCount() - 1;
											a >= 0;
											a--
										) {
											if (
												this.options.angleLines.display
											) {
							...
							n = t.Scale.extend({
								...
								getMomentStartOf: function(t) {
									return "week" === this.options.time.unit &&
										this.options.time.isoWeekday !== !1
										? t
												.clone()
												.startOf("isoWeek")
												.isoWeekday(
													this.options.time.isoWeekday
												)
										...
										e.each(
											...
											function(i, o) {
												...
												null !== i.data[0]
													...
													: (n = t),
													this.labelMoments.push(n);
											},
											this
										),
										this.options.time.min &&
											(this.firstTick = this.parseTime(
												this.options.time.min
											)),
										this.options.time.max &&
											(this.lastTick = this.parseTime(
												this.options.time.max
											)),
										(this.firstTick = (
											this.firstTick || a()
								...
								buildTicks: function(a) {
									...
									if (
										...
										for (
											...
											++g,
												(p = i.units[g]),
												(this.tickUnit = p.name);
											var b = this.firstTick.diff(
													this.getMomentStartOf(
														this.firstTick
													),
													this.tickUnit,
													!0
												),
												v = this.getMomentStartOf(
													this.lastTick
														.clone()
														.add(1, this.tickUnit)
												).diff(
									...
									if (
										(this.options.time.min
											? (x = this.getMomentStartOf(
													this.firstTick
											  ))
											: ((this.firstTick = this.getMomentStartOf(
													this.firstTick
											  )),
											  (x = this.firstTick)),
										!this.options.time.max)
									) {
										var y = this.getMomentStartOf(
											this.lastTick
										);
										0 !==
											y.diff(
									...
									var C = this.ticks[
										this.ticks.length - 1
									].diff(this.lastTick, this.tickUnit);
									(0 !== C || 0 === this.scaleSizeInUnits) &&
										(this.options.time.max
											? (this.ticks.push(
													this.lastTick.clone()
											  ),
								...
								getLabelForIndex: function(t, e) {
									...
									return (
										"object" ==
											typeof this.chart.data.datasets[e]
												.data[0] &&
								...
								getValueForPixel: function(t) {
									var e = this.isHorizontal()
										...
										i =
											...
											e;
									return (
										(i *= this.scaleSizeInUnits),
										this.firstTick
											.clone()
											.add(
												a
													.duration(i, this.tickUnit)
													.asSeconds(),
												"seconds"
											)
									);
								...
								parseTime: function(t) {
									return "string" ==
										typeof this.options.time.parser
