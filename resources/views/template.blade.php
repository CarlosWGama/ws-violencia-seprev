...
<body class="animsition">
    <div class="page-wrapper">
                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li>
                            <a href="{{route('usuarios.listar')}}">
                                <i class="fas fa-user"></i>Administradores</a>
                        ...
                        <!-- DENUNCIAS -->
                        <li>
                            <a href="{{route('denuncias.listar')}}">
                                <i class="fas fa-check"></i>Denúncias
                            </a>
                        </li>
                    </ul>
                </div>
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <a href="#">
                    <img src="{{asset('images/logo.png')}}" alt="SEPREV" />
                </a>
            </div>
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        {{-- AUTORES --}}
                        <li class="@if(isset($menu) && $menu == 'autores') active @endif">
                            <a href="{{route('autores.listar')}}">
                                <i class="fas fa-group"></i>Autores
                            </a>
                        </li>
                        {{-- DENUNCIAS --}}
                        <li class="@if(isset($menu) && $menu == 'denuncias') active @endif">
                            <a href="{{route('denuncias.listar')}}">
